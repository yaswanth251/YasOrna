...
const similarProducts = [
  {
    id: 2,
    image: "../assets/Images/products/Necklace/image18.png",
    title: "Diamond Necklace",
    price: 22000,
  },
  {
    id: 3,
    image: "../assets/Images/products/Necklace/image19.png",
    title: "Ruby Necklace",
    price: 18000,
  },
  {
    id: 4,
    image: "../assets/Images/products/Necklace/image20.png",
      ...
      <div className="mt-24 mx-auto max-w-5xl relative top-10 bg-white p-6 rounded-lg shadow-lg flex flex-col md:flex-row gap-6">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center">
          ...
          <div className="flex gap-4 mt-4">
            <button className="flex items-center gap-2 bg-orange-500 hover:bg-orange-600 text-white px-6 py-2 rounded-md shadow-md transition">
              <FaShoppingCart /> Add to Cart
            </button>
            <button className="flex items-center gap-2 bg-red-500 hover:bg-red-600 text-white px-6 py-2 rounded-md shadow-md transition">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center">
          ...
          <p className="text-gray-600 mb-4">
            Elegant handcrafted{" "}
            {product.title ? product.title.toLowerCase() : "product"} perfect
            for every occasion.
          </p>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
          {similarProducts.map((item) => (
            <div
              ...
              onClick={() =>
                navigate("/DetailView", { state: { product: item } })
              }
            >
              <img
                src={item.image}
